#!/bin/sh
#SBATCH -J satori
#SBATCH -o /users/jcurrie2/data_koconno5/jcurrie2/satori/250_50_promoters_epd_eval_test/satori_FLYFACTOR.out
#SBATCH -e /users/jcurrie2/data_koconno5/jcurrie2/satori/250_50_promoters_epd_eval_test/satori_FLYFACTOR.err
...
python3 satori_mine.py /users/jcurrie2/promoter_predict/250_50_dros_promoters_background_epd hparamfile.txt \
        --verbose \
        --outDir /users/jcurrie2/data_koconno5/jcurrie2/satori/250_50_promoters_epd_eval_test \
        --mode test \
        --splitperc 10 \
        --motifanalysis \
        --scorecutoff 0.75 \
